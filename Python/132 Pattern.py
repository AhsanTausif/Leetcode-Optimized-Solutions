class Solution:
    def find132pattern(self, nums: List[int]) -> bool:
        ...
        ## EDGE CASE : While checking the conditions 4,5,6. We should perform pop operation first
        ## i.e remove invalid elements before inserting the current element into the stack.
